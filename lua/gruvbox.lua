...
local function get_groups()
  ...
  local groups = {
    ...
    WinBar = { fg = colors.fg4, bg = "NONE" },
    WinBarNC = { fg = colors.fg3, bg = "NONE" },  -- fix inactive window Winbar bg colors
    ...
    DiagnosticVirtualTextError = { fg = colors.red, italic = config.italic.comments},
    DiagnosticVirtualTextWarn = { fg = colors.yellow, italic = config.italic.comments },
    DiagnosticVirtualTextInfo = { fg = colors.blue, italic = config.italic.comments},
    DiagnosticVirtualTextHint = { fg = colors.aqua, italic = config.italic.comments},
    ...
    IlluminatedCurWord = { bg = "#d7005f"},
    IlluminatedWordText = { bg = "#d7005f" },
    IlluminatedWordRead = { bg = "#d7005f"  },
    IlluminatedWordWrite = { bg = "#d7005f" },
